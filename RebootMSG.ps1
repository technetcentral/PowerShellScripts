<#
Invoke-Command -Computer 163b, 155b, 156b -ScriptBlock {
...
function vpcRebootMSG{

$stamp = Get-Date -Format d-MMMM-yyyy-HHmm
Import-Module pslogging
$logpath = “\\FILESRV\DomainShare\admins\logs\powerShellScripts\VirtualPCRebootMSG$stamp.log”
Start-Log -LogPath “\\FILESRV\DomainShare\admins\logs\powerShellScripts\” -LogName “VirtualPCRebootMSG$stamp.log” -ScriptVersion “1.0” 
...
foreach($obj in $C) {
            ...
            if (Test-Connection -ComputerName $obj -Quiet) {
                    ...
                    Invoke-command -computername $obj -scriptblock {
                        ...
                        $CmdMessage = { msg * 'Hello' $GetUserName  " Weekly system maintenance is scheduled to begin in 30mins, `
                         please close all apps and disconnect to perserve your data."}
      ...
      Write-LogInfo -LogPath $logpath -TimeStamp "Reboot message sent to all virtual pcs listed above except where indicated"
